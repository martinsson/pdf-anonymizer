...
var wordList = scriptArgs[2]

var anonymizer = new pdf.Anonymizer(inputFile, null, SubstitutionFrequencies, CharacterWhitelist, Resolution, MaskImages);
anonymizer.run(outputFile, null, wordList);
